        ...
        >
          ...
          >
            ...
            <div className='mb-4'>
              ...
              <p>
                <span className='text-green-700'>Name:</span> {selectedOrder.user?.name}
              </p>
              <p>
                <span className='text-green-700'>Email:</span> {selectedOrder.user?.email}
              </p>
              <p>
                <span className='text-green-700'>Phone:</span> {selectedOrder.address?.phone}
              </p>
              <p>
