...
export default function StoreAddProduct() {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      if (!images[1] && !images[2] && !images[3] && !images[4]) {
        return toast.error('Lütfen en az bir resim yükleyiniz') // 'Please upload at least one image'
      }
      setLoading(true)
  ...
  return (
    <form
      onSubmit={(e) => toast.promise(onSubmitHandler(e), { loading: 'Ürün ekleniyor...' })}
      className='text-slate-500 mb-28'
    >
      <h1 className='text-2xl'>
        Yeni Eklenen <span className='text-slate-800 font-medium'>Ürünler</span>
      </h1>
      <p className='mt-7'>Ürün Resimleri</p>
