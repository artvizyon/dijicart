...
import { BanknoteArrowDown, ShoppingBasketIcon, StarIcon, TagsIcon } from 'lucide-react'
...
export default function Dashboard() {
  ...
  const dashboardCardsData = [
    { title: 'Ürünler Toplamı', value: dashboardData.totalProducts, icon: ShoppingBasketIcon },
    {
      title: 'Satışlar Toplamı ',
      value: dashboardData.totalEarnings + ' ' + currency,
      icon: BanknoteArrowDown,
    },
    { title: 'Siparişler Toplamı', value: dashboardData.totalOrders, icon: TagsIcon },
    { title: 'Yorumlar Toplamı', value: dashboardData.ratings.length, icon: StarIcon },
  ]
  ...
  return (
    <div className=' text-slate-500 mb-28'>
      <h1 className='text-2xl'>
        Satıcı <span className='text-slate-800 font-medium'>Yönetim Paneli</span>
      </h1>
