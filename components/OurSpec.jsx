...
const OurSpecs = () => {
    ...
    return (
        <div className='px-6 my-20 max-w-6xl mx-auto'>
            <Title visibleButton={false} title='Hizmet Standartlarımız' description="Alışveriş deneyiminizin sorunsuz, güvenli ve tamamen zahmetsiz olmasını sağlamak için en üst düzeyde hizmet ve kolaylık sunuyoruz." />
