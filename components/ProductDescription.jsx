    ...
    return (
        <div className="my-18 text-sm text-slate-600">
            ...
            <div className="flex gap-3 mt-14">
                ...
                <div>
                    <p className="font-medium text-slate-600">Satıcı {product.store.name}</p>
                    <Link href={`/shop/${product.store.username}`} className="flex items-center gap-1.5 text-green-500"> Mağazaya git <ArrowRight size={14} /></Link>
                </div>
            </div>
        </div>
    )
