...
const AdminSidebar = () => {
    ...
    const sidebarLinks = [
        { name: 'Uöntim Paneli', href: '/admin', icon: HomeIcon },
        { name: 'Mağazalar', href: '/admin/stores', icon: StoreIcon },
        { name: 'Mağaza Onay', href: '/admin/approve', icon: ShieldCheckIcon },
        { name: 'Kuponlar', href: '/admin/coupons', icon: TicketPercentIcon  },
    ]

    return (
        <div className="inline-flex h-full flex-col gap-5 border-r border-slate-200 sm:min-w-60">
            <div className="flex flex-col gap-3 justify-center items-center pt-8 max-sm:hidden">
                <Image className="w-14 h-14 rounded-full" src={assets.aa_logo} alt="" width={80} height={80} />
