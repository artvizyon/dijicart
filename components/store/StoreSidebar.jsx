...
const StoreSidebar = ({storeInfo}) => {
    ...
    const sidebarLinks = [
        { name: 'Yönetim Paneli', href: '/store', icon: HomeIcon },
        { name: 'Ürün Ekle', href: '/store/add-product', icon: SquarePlusIcon },
        { name: 'Ürün Güncelle', href: '/store/manage-product', icon: SquarePenIcon },
        { name: 'Siparişler', href: '/store/orders', icon: LayoutListIcon },
    ]
