  ...
  const linkSections = [
    {
      title: 'ÜRÜNLER',
      links: [
        { text: 'DIN 912 IMBUS', path: '/', icon: null },
        { text: 'DIN 916 SETSKUR', path: '/', icon: null },
        { text: 'DIN 933 CIVATA', path: '/', icon: null },
        { text: 'DIN 127 RONDELA', path: '/', icon: null },
      ],
    },
    {
      title: 'WEB SİTE',
    ...
    <footer className='mx-6 bg-white'>
      <div className='max-w-7xl mx-auto'>
        ...
        <p className='py-4 text-sm text-slate-500'>
          Copyright 2025 © Thales Danışmanlık. Tüm Hakları Saklıdır.
        </p>
      </div>
    </footer>
  )
