import aa_logo from "./aa_logo.jpg"
import happy_store from "./happy_store.webp"
import upload_area from "./upload_area.svg"
import dijitrend_logo from "./dijitrend_logo.svg"
...
export const assets = {
    upload_area, dijitrend_logo,hero_model_img,
    hero_product_img1, hero_product_img2, aa_logo,
    product_img1, product_img2, product_img3, product_img4, product_img5, product_img6,
    product_img7, product_img8, product_img9, product_img10, product_img11, product_img12,
}

export const categories = ["DIN 912", "DIN 933", "DIN 916", "ISO 7261", "DIN 128", "DIN 7060"];
...
export const ourSpecsData = [
    { title: "Ücretsiz Kargo", description: "Her siparişinizde hızlı ve ücretsiz teslimatın keyfini çıkarın.", icon: SendIcon, accent: '#05DF72' },
    { title: "Geri İade", description: "Fikriniz mi değişti? Endişelenmeyin. Herhangi bir ürünü 7 gün içinde iade edin..", icon: ClockFadingIcon, accent: '#FF8904' },
    { title: "Danışmanlık Hizmetleri", description: "Sizin için buradayız. Müşteri desteğimizle uzman yardımı alın.", icon: HeadsetIcon, accent: '#A684FF' }
]
...
export const addressDummyData = {
    ...
    country: "Türkiye",
    phone: "1234567890",
    createdAt: 'Sat Jul 19 2025 14:51:25 GMT+0530 (Istanbul Standard Time)',
}
